...
// O ctx vem da requisição HTTP de entrada e carrega o trace distribuído: é ele que
// costura os spans deste serviço com os do flag-service e do targeting-service.
...
func (a *App) fetchFlag(ctx context.Context, flagName string) (*Flag, error) {
	...
	// NewRequestWithContext propaga o traceparent no header da chamada de saída.
